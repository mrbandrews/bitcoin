...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            "listunspent ( minconf maxconf  [\"addresses\",...] [include_untrusted] )\n"
            ...
            "      ,...\n"
            "    ]\n"
            "4. include_untrusted (bool, optional, default=true) Include untrusted transactions.\n"
            "\nResult\n"
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "wallet",             "listunspent",              &listunspent,              false,  {"minconf","maxconf","addresses","include_untrusted"} },
